...
The 2026 TOC election will be conducted using a [CFF-managed instance](https://elections.cloudfoundry.org) of [Elekto](https://elekto.dev), a CNCF infrastructure project
...
should be, please file a voting exception request [within the Elekto app](https://elections.cloudfoundry.org/app/elections/2026---TOC/exception) or [via an issue on the
...
The newly elected body will be announced via cf-dev@lists.cloudfoundry.org on 27 Jul, 2026.
